...
7. **Waveform and Assertion Triage** - Active next milestone: capture simulator outputs, waveforms, assertions, and failure summaries.
...
Stages 1 through 6 are complete. Stage 7 is active.
